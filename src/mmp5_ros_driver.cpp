...
{
	if (robot != NULL) robot->setSpeeds(msg->linear.x,msg->angular.z); else ROS_WARN("MMP5 robot not initialized");
}
...
int main(int argc, char** argv)
{
	...
	n.param("mmp5_maxForwardSpeed",maxForwardSpeed,0.5);
	n.param("mmp5_maxBackwardSpeed",maxBackwardSpeed,0.5);
	n.param("mmp5_maxTurnSpeed",maxTurnSpeed,0.5);
	n.param("mmp5_forwardSpeedGain",forwardSpeedGain,10.0);
